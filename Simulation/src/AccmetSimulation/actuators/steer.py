...
class Steer(morse.core.actuator.Actuator):
    ...
    def __init__(self, obj, parent=None):
        ...
        self.nav                    = 0
        self.navCellPoseX           = -27.18592 ## assigned with start cell X-Coordinate
    ...
    def SetTargetBlenderCoordinate(self, relativeDist):
        ...
        if relativeDist > 0:
            ...
            print("Relative distance has been set", self.navCellPoseX, self.navCellPoseY)
        else:
    ...
    def GetWagonRailCoordinate(self):
        ...
        for poly in self.nav.data.polygons:
            ...
            if previousCell:
                ...
                diffPoseX       = currentPoseX - startCellX
                diffPoseY       = currentPoseY - startCellY
                diffCellX       = endCellX - startCellX
                diffCellY       = endCellY - startCellY
...
##########################################   Steer Module Services   ######################################################
    ...
    def Initialize(self):
        ...
        """
        self.SetNavMesh(1)
        self.navCellPoseX = -27.18592 ## assigning with the start cell X-Coordinate
        self.navCellPoseY = -16.55265 ## assigning with the start cell Y-Coordinate
        self.Stop()
        self.initFlag = True
        self.wagon.actuators['GoForward'].target.position = [-27.18592, -16.55265, self.navCellPoseZ]
